...
function my_keydown(e)
{
	...
	function up()
	{
		...
		if (ball_y >= 5) {
			...
			console.log("Quando a seta para cima for precionada, X =" + ball_x +" | Y =" + ball_y);
			canvas.remove(ball_obj);
			new_image();
		 }
	}
	...
	function down()
	{
		 ...
		 if (ball_y <= 450) {
			ball_y = ball_y + block_image_height;
			console.log("altura do bloco da imagem" + block_image_height);
			console.log("Quando a seta para baixo for precionada, X =" + ball_x +" | Y =" + ball_y);
			canvas.remove(ball_obj);
			new_image();
		 }
	}
	...
	function left()
	{
		if(ball_x >= 5)
		{
			...
			ball_x = ball_x - block_image_width;
				...
				console.log("Quando a seta para esquerda for precionada, X =" + ball_x +" | Y =" + ball_y)
				canvas.remove(ball_obj);
				new_image();
		}
	}
	...
	function right()
	{
		if(ball_x <=1050)
		{
			...
			console.log("Quando a seta para direita for precionada, X =" + ball_x +" | Y =" + ball_y);
			canvas.remove(ball_obj);
			new_image();
		}
	}
